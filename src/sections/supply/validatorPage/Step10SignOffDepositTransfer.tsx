...
const Step10SignOffDepositTransfer = () => {
        ...
        {(formikProps) => (
          <Form>
            <Stack spacing="6">
              ...
              <ImageUpload
                name={'depositCarForm'} label={'Deposit Car Form'}
                onChange={(url: string) => formikProps.setFieldValue('depositCarForm', url)}
                filePath='depositCarForm'
              />

              <ImageUpload
                name={'transferForm'} label={'Transfer Form'}
                onChange={(url: string) => formikProps.setFieldValue('transferForm', url)}
                filePath='transferForm'
              />
...
export default Step10SignOffDepositTransfer;
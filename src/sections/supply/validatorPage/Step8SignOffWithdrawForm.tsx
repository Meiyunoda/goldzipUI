...
const Step8SignOffWithdrawForm = () => {
      ...
      >
        {(formikProps) => (
          <Form>
            <Stack spacing="6">
              <ImageUpload
                name={'withdrawForm'} label={'Withdraw Form'}
                onChange={(url: string) => formikProps.setFieldValue('withdrawForm', url)}
                filePath='withdrawForm'
              />

              <ImageUpload
                name={'withdrawCarForm'} label={'Withdraw Car Form'}
                onChange={(url: string) => formikProps.setFieldValue('withdrawCarForm', url)}
                filePath='withdrawCarForm'
              />
...
export default Step8SignOffWithdrawForm;
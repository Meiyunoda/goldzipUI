import { Accordion, AccordionButton, AccordionIcon, AccordionItem, AccordionPanel, Box, Button, Checkbox, Stack, Text, useToast } from '@chakra-ui/react';
...
const Step108GoldPendingPickup = () => {
  let { data: tickets, error } = useSWR(getTicketUrl, fetcher)
        ...
        {(formikProps) => (
          <Form>
            <Stack spacing="6">
              ...
              <Checkbox isRequired>Gold is pick up by redeemer</Checkbox>
...
export default Step108GoldPendingPickup;